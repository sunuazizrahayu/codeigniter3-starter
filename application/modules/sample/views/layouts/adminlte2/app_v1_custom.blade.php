<?php
$theme = 'https://adminlte.io/themes/v2.4.x/';
$app_name = 'AdminLTE 2';
$app_url = site_url();
?>
<!DOCTYPE html>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?=current_url() ?>"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <li>
            <a href="javascript:void(0)">
              ...
              <div class="menu-info">
                ...
                <p><span class="__cf_email__" data-cfemail="c2acadb0a382a7baa3afb2aea7eca1adaf">[email&#160;protected]</span></p>
              </div>
            </a>
          </li>
          <li>
...
$(function() {
  ...
  var menuItem = $('.sidebar-menu li a').filter(function () {
    return this.href.endsWith(current);
  }).parent(); // Find the menu item that matches

  menuItem.addClass('active'); // Add the 'active' class to it

  // Optionally, highlight parent menus if needed
  menuItem.parents('.treeview').addClass('active'); // If the menu item is within a treeview
});
</script>
@yield('js')
</body>
