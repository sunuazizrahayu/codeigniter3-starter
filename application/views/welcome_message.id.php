...
<div id="container">
	...
	<div id="body">
		...
		<p>Jika Anda ingin mengedit halaman ini, Anda dapat menemukannya di:</p>
	...
	<p class="footer">Halaman dimuat dalam <strong>{elapsed_time}</strong> detik. <?php echo  (ENVIRONMENT === 'development') ?  'Versi CodeIgniter <strong>' . CI_VERSION . '</strong>' : '' ?></p>
</div>
