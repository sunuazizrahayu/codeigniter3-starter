...
if (!is_cli() && empty($config['base_url'])) {
	$config['base_url'] = (is_https()) ? "https" : "http";
	$config['base_url'] .= "://".($_SERVER['HTTP_X_FORWARDED_HOST'] ?? $_SERVER['HTTP_HOST']);
...
$config['language_abbr_list'] = array("en"=>"english", "id"=>"indonesia");
...
*/
$config['composer_autoload'] = BACKPATH . 'vendor/autoload.php';
